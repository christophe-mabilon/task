...
<p>
  ...
  <button class="ms-2 py-0 btn fs-6" mat-flat-button [appTaskStatusColor]="task.status">{{ task.status }}</button>
</p>
```
    ...
    <div class="col-12">
      <div class="mb-3">
        <mat-form-field class="col-12">
          ...
          <input matInput formControlName="title" type="email" id="titre" placeholder="titre de la task" />
        </mat-form-field>
      ...
      <div class="mb-3">
        <mat-form-field class="col-12">
          ...
          <textarea matInput formControlName="description" id="description" rows="3"></textarea>
        </mat-form-field>
        <app-error-min-length
          [showError]="
      ...
      <div class="col-12 justify-content-end ms-auto">
        <div class="d-flex justify-content-end ms-auto align-items-center">
          <button mat-raised-button (click)="initForm()" class="cancel mx-2">Annuler</button>
          <button (click)="addTask()" mat-raised-button class="mx-2" color="primary">Valider</button>
        </div>
      </div>
    </div>
  </div>
...
@NgModule({
  declarations: [],
  imports: [CommonModule, ErrorMaxLengthFieldFormComponent, ErrorMinLengthFieldFormComponent, ErrorRequiredFieldFormComponent],
  exports: [ErrorMaxLengthFieldFormComponent, ErrorMinLengthFieldFormComponent, ErrorRequiredFieldFormComponent],
})
